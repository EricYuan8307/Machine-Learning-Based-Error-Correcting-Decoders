...
BP = [0.0265, 0.018725, 0.013625, 0.0079, 0.0048, 0.003075, 0.0015113636363636364,7.136363636363637e-04,
      ...
      0, 0, 0, 0, 0, 0, 0]
MLNN = [0.070925, 0.0591, 0.0502, 0.0397, 0.03155, 0.025175, 0.02035, 0.0139, 0.010925, 0.0069, 0.00475, 0.003125,
        0, 0, 0, 0, 0, 0, 0, 0, 0]
...
plt.legend(['uncoded_BPSK', 'HDML', 'SDML', "BP", "MLNN"], loc='lower left')
# Display the Plot
plt.show()