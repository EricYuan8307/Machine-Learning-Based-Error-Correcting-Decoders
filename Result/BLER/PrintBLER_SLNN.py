...
BLER_SLNN = [0.181115, 0.146799, 0.115747, 0.088663, 0.065622, 0.04572, 0.031125, # 0~3
             0.019974, 0.012339, 0.007, 0.003762, 0.00197, 0.000906, 0.000422, 0.000199 # 3.5~7.0
             ]
...
plt.legend(['Soft-decision ML', 'BPSK, Uncoded','Single-label Neural network'], loc='lower left')
