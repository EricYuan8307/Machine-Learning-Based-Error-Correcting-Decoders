...
class MultiLabelNNDecoder2(nn.Module):
    def __init__(self, input_size, hidden_size0, hidden_size1, output_size):

        super().__init__()
        self.input_size = input_size
        self.hidden0 = nn.Linear(input_size, hidden_size0)
        self.hidden1 = nn.Linear(hidden_size0, hidden_size1)
        self.relu = nn.ReLU()
